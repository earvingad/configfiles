...
alias myip='ip address | grep wlan0 | grep inet | cut -d " " -f6 | cut -d "/" -f1'
...
alias helium='./.scripts/sshfs.sh'
alias musync='rsync -av --delete Música/music/ helium:/home/media/music'
